...
DEBUG=-DCMAKE_BUILD_TYPE=Debug -DC_UTILS_DBGFLAGS=ON
RELWITHDEBINFO=-DCMAKE_BUILD_TYPE=RelWithDebInfo -DC_UTILS_DBGFLAGS=ON
RELEASE=-DCMAKE_BUILD_TYPE=Release -DC_UTILS_DBGFLAGS=ON
